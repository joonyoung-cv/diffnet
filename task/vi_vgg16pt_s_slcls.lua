...
function task:changeModelTest( model )
	...
	model.modules[ 1 ]:insert( lin2conv( model.modules[ 1 ].modules[ 35 ], 4096 ), 35 )
	model.modules[ 1 ]:remove( 36 )
	model.modules[ 2 ]:insert( lin2conv( model.modules[ 2 ].modules[ 1 ], 4096 ), 1 )
